...
const COMMANDS = {
  ...
  about: {
    output: [
      ...
      "│  Speciality:   FastAPI (Python) & React/Next.js",
      "│",
      "│  A battle-tested engineer who builds",
      "│  high-performance backend systems with",
      "│  FastAPI and crafts modern, responsive",
  ...
  projects: {
    output: [
      ...
      "│  [12] Smart Loan Advisor    ◈ CLASSIFIED",
      "│",
      "│  Total: 12 projects | 8 live | 1 showcase | 3 classified",
      "│",
      "└────────────────────────────────────────────",
    ],
  },
